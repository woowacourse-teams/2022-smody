...
== 랭킹 기간 조회
=== Request
include::{snippets}/get-all-rankManager-periods/http-request.adoc[]
=== Response
include::{snippets}/get-all-rankManager-periods/http-response.adoc[]
=== Response 필드
include::{snippets}/get-all-rankManager-periods/response-fields.adoc[]

== 랭킹 활동 조회
=== Request
include::{snippets}/get-rankManager-activities/http-request.adoc[]
=== Response
include::{snippets}/get-rankManager-activities/http-response.adoc[]
=== Response 필드
include::{snippets}/get-rankManager-activities/response-fields.adoc[]
